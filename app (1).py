...
# ============================================================
# PROCUREYE RELEASE 42.1.1 — EMBEDDED DRIVER INTELLIGENCE FIX
# ============================================================

def _driver_intelligence_number(value, default=0.0):
    try:
...
def analyze_driver_intelligence(news):
    ...
    for _, item in news.iterrows():
        ...
        impact = _driver_intelligence_number(
            item.get("Impact", 0.0)
        )

        confidence = _driver_intelligence_number(
...
def render_driver_intelligence(report):
    st.markdown(
        """
